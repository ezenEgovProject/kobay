...
<div class="container">
	<h3 class="mt-4 mb-3 pr-3" align="right">Recently Auction List</h3>
	<hr/>
	<ol class="breadcrumb bg-white">
       <li class="breadcrumb-item">
       		최근 등록된 <span class="strong text-warning">경매예정물품</span>을 확인해보세요!
       </li>
	</ol>
     <div class="row">
     ...
     <!-- /.row -->
      	<h3 class="mt-4 mb-3 pr-3" align="right">Expecting Auction List</h3>
      	<hr/>
		<ol class="breadcrumb bg-white">
	       <li class="breadcrumb-item"  style="vertical-align: middle;">
	       		<span style="vertical-align: middle">
	       			진행예정된 경매 상품 수: <span class="strong text-success">${totcnt2}개</span>
	       		</span>
	       </li>
	       <li>
