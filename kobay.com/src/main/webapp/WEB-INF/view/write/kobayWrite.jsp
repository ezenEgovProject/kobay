	...
	$(function() {
		...
		$("#saveBtn").click(function() {
			...
			$.ajax({
				type : 'POST',
				data : form,
				url : "<c:url value='/uploadFileSave2'/>",
				dataType : "json",
			...
			success : function(data) {
				if (data.resultMList != null) {
					...
					for(var i=0;i<resultMList.length;i++){
						if(ctgcd == resultMList[i].ctgcd){
						     
							Document.frm.Mcategory.append("<option value='"+resultMList[i].ctgcd+"'>"+resultMList[i].ctgnm+"</option>");
...
<body>
	...
	<!-- Navigation -->
	<nav class="navbar navbar-default fixed-top navbar-static-top bg-blue"
		...
		<div class="container" style="width: 100%;">
			<div class="row justify-content-between align-items-center"
					...
					<div class="input-group">
						<span class="input-group-btn">
							<button class="btn search-btn" type="button">
								<i class="fa fa-search fa-lg" style="color: #0080ff"></i>
							</button>
				...
				<div class="col-6 col-sm-auto order-sm-3">
					<span class="top-icon"><i class="fa fa-user-circle-o fa-2x"
						aria-hidden="true" style="color: #ffffff"></i></span> <span
						class="top-icon"><i class="fa fa-shopping-cart fa-2x"
						aria-hidden="true" style="color: #ffffff"></i></span>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav mx-auto">
					<li class="nav-item px-lg-4"><a class="nav-link" href="#">About</a>
					</li>
					<li class="nav-item px-lg-4"><a class="nav-link" href="#">Services</a>
					</li>
					<li class="nav-item px-lg-4"><a class="nav-link" href="#">Contact</a>
					</li>
					<li class="nav-item px-lg-4 dropdown"><a
						class="nav-link dropdown-toggle" href="#"
						id="navbarDropdownPortfolio" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> Portfolio </a>
						<div class="dropdown-menu dropdown-menu-right"
							aria-labelledby="navbarDropdownPortfolio">
							<a class="dropdown-item" href="#">1 Column Portfolio</a> <a
								class="dropdown-item" href="#">2 Column Portfolio</a> <a
								class="dropdown-item" href="#">3 Column Portfolio</a> <a
								class="dropdown-item" href="#">4 Column Portfolio</a> <a
								class="dropdown-item" href="#">Single Portfolio Item</a>
						</div></li>
					<li class="nav-item px-lg-4 dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="#">Blog Home 1</a> <a
								class="dropdown-item" href="#">Blog Home 2</a> <a
								class="dropdown-item" href="#">Blog Post</a>
						</div></li>
					<li class="nav-item px-lg-4 dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdownBlog"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<div class="dropdown-menu dropdown-menu-right"
							aria-labelledby="navbarDropdownBlog">
							<a class="dropdown-item" href="#">Full Width Page</a> <a
								class="dropdown-item" href="#">Sidebar Page</a> <a
								class="dropdown-item" href="#">FAQ</a> <a class="dropdown-item"
								href="#">404</a> <a class="dropdown-item" href="#">Pricing
								Table</a>
						</div></li>
				</ul>
			</div>
					...
					<form name="sentMessage" id="contactForm" novalidate>
						<div class="control-group form-group">
							<div class="controls">
								...
								</select> <select id="Mcategory" name="Mcategory">
						...
						<div class="control-group form-group">
							<div class="controls">
								...
								<label>등록기간:</label> <input type="text" class="form-control"
									name="sdate" id="sdate" style="width: 30%;"> ~ <input
							...
							<div class="controls">
								...
								<div class="filebox bs3-primary preview-image">
									<input class="upload-name" value="파일선택" disabled="disabled"
										style="width: 200px;"> <label for="file1">업로드</label>
						...
						<div class="control-group form-group">
							<div class="controls">
								<label>배송료:</label> <input type="text" class="form-control"
									name="deliverypee" id="deliverypee">
							</div>
						</div>
						...
						<div class="control-group form-group">
							<div class="controls">
								<label>노출여부:</label> <select name="auction_del" id="auction_del">
